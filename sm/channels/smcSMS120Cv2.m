...
%
%		Driver flag: waitforrampfinishflag = [0|1] copntrols wetehr driver will return control to matlab before sweep has finished. Default is off, i.e. Matlab waits for sweep to finish before executing further commands. 
